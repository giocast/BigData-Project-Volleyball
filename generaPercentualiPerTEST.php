...
// FILE DI TEST: Modena-Perugia Champions League Quarti Andata -> ESITO 3-0 (sorpresa nel risultato, ma percentuali parlano
// File scout gentilmente offerto dallo scout di Perugia (NOTA: Squadra A e B sono invertite)
$file = fopen("_QuaCL1_Sir_Safety__vs_Leo_Shoes_M.dvw","r"); 
...
echo "<script>alert('Data Match: ".$dataMatch." Formazioni ".$codiceSquadraA."-".$codiceSquadraB."');</script>";
echo "<script>alert('Esito Match: ".$esitoGara." EsitoML: ".$esitoGaraPerML."');</script>";
echo "<script>alert('Percentuali da fornire ad Alg ML: %EffAttackA".$percentualeAttaccoA." %EffAttackB ".$percentualeAttaccoB."  %EffBlockA ".$percentualeMuroA." %EffBlockB ".$percentualeMuroB." %EffServiceA ".$percentualeBattutaA." %EffServiceB ".$percentualeBattutaB."');</script>";
?>